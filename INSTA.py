...
# =============================================================================
    ...
    def clickMethod(self):
        ...
        file_list = drive.ListFile({'q': "title contains 'Notes.docx' and trashed=false"}).GetList()
        print(file_list[0]['title']) # should be the title of the file we just created
        file_id = file_list[0]['id'] # get the file ID 
        ...
        stuff =("https://drive.google.com/drive/folders/1kcRbK37uBnLMRXU41AGdUf_JuBBLNVS5?usp=sharing")
        x=qrcode.make(stuff)
        x.save("QR.jpg")    
